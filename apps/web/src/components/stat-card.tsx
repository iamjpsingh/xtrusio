...
type StatCardProps = {
  ...
  hint?: string;
  /** When true, render a value-line skeleton instead of the value (loading). */
  loading?: boolean;
};
 ...
 * zero-data dashboard reads as intentional rather than broken. When `loading`
 * is set, the value line becomes a `Skeleton` so the in-flight tile keeps its
 * shape. Monochrome, tokens only.
 */
